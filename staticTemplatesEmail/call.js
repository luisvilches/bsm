  ...
  <container>
    ...
    <row class="pd2">
        <column large="12" small="12" style="background:#ffffff;border-radius:10px;">
            <block>
              <h1 style="text-align:center;color:#32A641;font-size:25px;">Nueva solicitud de llamada</h1>
              <block style="background:#eee;border-radius:8px;">
                <table>
                  ...
                  <tr>
                    <td style="color:#3A3A3A;font-weight:700;">Servicio:</td>
                    <td style="color:#32A641">{service}</td>
                  </tr>
                </table>
              </block>
            </block>
    ...
    <row>
      <column large="12" small="12">
        <button href="tel:{phone}" style="margin: auto;background:#32A641;width:160px; height:40px; border-radius:5px">Llamar ahora</button>
      </column>
    </row>
    <row>
      <column large="12" small="12">
